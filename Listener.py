...
class SocketListener:
    def __init__(self,ip,port):
        ...
        my_listener.setsockopt(socket.SOL_SOCKET,socket.SO_REUSEADDR,1) #instance useable one more times
        my_listener.bind((ip,port))
        my_listener.listen(0) #backlog
        print("Listening....")
...
my_socket_listener = SocketListener("10.0.2.8",8080)
